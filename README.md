...
1. How did the idea for the company (or project) come about?
    - The idea for Dysolve emerged from Dr. Hoh's extensive research into neurological conditions.  As a consultancy, EduNational's initial focus was on designing intervention programs for special education.  It later evolved into an AI firm, in order to build AI systems to address learning disabilities, like dyslexia.

1. How is the company funded? How much funding have they received?
    - The company is primarily funded through [monthly subscription](https://dysolve.com/programsss/#what_dysolve_costs) from their customers at $222 for the Basic plan and $389 for the premier plan.
...
1. Who is the company's intended customer? Is there any information about the market size of this set of customers?
    - The software is designed for individuals experiencing difficulty reading, due to dyslexia, and other learning disorders.  Statistics indicate [one in five people in the United States have dyslexia](https://youtu.be/MRVK5boZriI).  That accounts for roughly 20% of the U.S. population, which is approximately 66.8 million people.
...
1. What field is the company in?
    - EduNational is in the field of education (EdTech) and healthcare.  The company focusses on artificial intelligence (AI) for diagnosing and treating language-related disorders such as dyslexia and other related conditions. 
...
1. What has been the business impact of this company so far?
    - EduNational has significantly influenced the education and healthcare sectors since its transition into an AI firm, achieving notable success despite being relatively small in size. It has reported between 1 to 5 million annual revenue since inception, despite having only 18 employees. EduNational continues to bring social awareness to the financial burden that outdated screening policies are placing on families and school districts.  For instance, Ortan Gillingham (OG/MLS) is a popular dyslexia intervention program, in the U.S.  In some states teachers are required to receive special training and certifications in this method, despite the lack of evidence to support the long-term efficacy of the program.  Dysolve has positioned itself as a cost-effective solution that can transform the Special Education system.  Case studies have proven academic performance gains within two months of program completion, at [1% of the cost per student in New York, and under 10% of special education cost in state funding](https://observer.com/2024/09/new-yorks-dyslexia-bill-how-ai-can-transform-special-education-and-save-billions/).
...
1. Products or services expansion suggestions:
    - EduNational should consider expanding to become the leader in special education intervention from K-12.  As such, it should incorporate products to treat comorbid conditions such as dyscalcula or dysgraphia, which also affects individuals with dyslexia.  
...
1. Required technologies for additional products and services:
    - The product would not require any new technologies, instead it would be an extension of the current technology to improve cognitive processes for a different type of disorder.  However, additional research would be required to identify appropriate evaluation and remediation metrics.
1. Why are these technologies appropriate for your solution?
    - Dysolve has proven itself to be an effective tool to identify deficiencies in linguistic processes, by targeting underlying issues.  It can be reasonably assumed that a similiar approach would be effective in correcting problems with fine motor skills, in addition to spatial and numerical reasoning.
## References
