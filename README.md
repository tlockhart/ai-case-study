...
1. ### Founders:  
    - EduNational LLC was originally [founded in 2007 by Dr. Coral PS Hoh](https://www.dysolve.com/wp-content/themes/dysolve/images/EduNational-Backgrounder-1.pdf), as a consultancy, to address the needs of neurodiverse individuals.  
...
1. ### Origin: 
    - The idea for Dysolve emerged from Dr. Hoh's extensive research into neurological conditions.  As a consultancy, EduNational's initial focus was on designing intervention programs for special education.  It later evolved into an AI firm, to build AI systems to address learning disabilities, like dyslexia.

1. ### Funding:
    - The company is primarily funded through [monthly subscriptions](https://dysolve.com/programsss/#what_dysolve_costs) from their customers at $222 for the Basic plan and $389 for the Premier plan.
...
1.  ### Expansion Assumptions:
    - Dysolve has proven itself to be an effective tool to identify deficiencies in linguistic processes, by targeting underlying issues.  It can be reasonably assumed that a similar approach would be effective in correcting problems with fine motor skills, in addition to spatial and numerical reasoning.
## References
